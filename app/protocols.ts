...
export const protocols: Protocol[] = [
  {
    ...
    duration:
      "Applies until 5 consecutive trading days are completed without violation.",
    failure:
  ...
  },
  {
    ...
    duration:
      "Applies until 5 consecutive trading days are completed without violation.",
    failure:
      "Any change to position size (adds or reductions), stop level, target, trailing logic, partial rules, or exit conditions after entry ends the run.",
  },
  {
  ...
  },
  {
    ...
    duration:
      "Applies until 5 consecutive trading days are completed without violation.",
    failure:
      "Placing an entry that exceeds either declared maximum (total entries or concurrent positions) ends the run.",
  },
  {
    ...
    duration:
      "Applies until 5 consecutive trading days are completed without violation.",
    failure:
      "Entering any trade without a pre-session recorded regime classification, or entering any trade on a day classified as risk-off, ends the run.",
  },
  {
    ...
    duration:
      "Applies until 5 consecutive trading days are completed without violation.",
    failure:
      "Entering on any bar after the trigger bar, adjusting price to \"improve entry,\" or hesitating in a way that results in a late entry ends the run.",
  },
  {
    ...
    duration:
      "Applies until 5 consecutive trading days are completed without violation.",
    failure:
      "Executing any trade that does not meet the declared strategy's criteria ends the run.",
  },
  {
